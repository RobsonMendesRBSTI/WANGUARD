...
## curl -s --max-time 10 -d "chat_id=-1001826050802&disable_web_page_preview=1&text=WANGUARD: Ataque detectado contra o prefixo TESTE" https://api.telegram.org/bot747889846:AAEbNzmHVU7pEl1Gp3Y3j0VvoI7g4Sot7Kc/sendMessage > /dev/null

!/usr/bin/env bash
#/opt/andrisoft/bin/telegram.sh {prefix} {decoder} {anomaly_id} {sensor} {value_prefix} {unit}

USERID="-1001826050802"
...
#$SENSOR$INTERFACE$PREFIX$VECTOR$
